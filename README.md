...
<p align="center">
Designing and building scalable backend systems in fintech, <br/> with a strong focus on cloud architecture, reliability, and high performance at scale.
</p>

<p align="center">
  <a href="https://www.linkedin.com/in/felipeth04/" target="_blank">
...
### 🏆 CERTIFICATIONS  
  ...
  <img width="180" height="180" alt="image" src="https://github.com/user-attachments/assets/6788f3c1-e13f-4a4d-a70c-0396753eca56" />
  <img width="180" height="180" alt="image" src="https://github.com/user-attachments/assets/4d0fd306-56bb-4cb4-a7c1-a552c65392c2" />
  <img width="180" height="180" alt="image" src="https://github.com/user-attachments/assets/a5e9db6d-36fd-4bba-84f2-a6fef701d697" />
...
<table width="100%" cellspacing="0" cellpadding="0" style="border-collapse: separate; border-spacing: 0 12px; table-layout: fixed;">
  <tr>
    <td style="border: 1px solid #cfcfcf; width: 96px; height: 96px; background: #ffffff; padding: 0; text-align: center; vertical-align: middle;">
      <img
        src="https://github.com/user-attachments/assets/f786713f-5e58-4627-bca6-3f97bf2ba1ac"
        alt="Mercado Pago"
        style="display: block; width: 72px; height: 72px; object-fit: contain; margin: 12px auto;"
      />
    </td>
  ...
  <tr>
    <td style="border: 1px solid #cfcfcf; width: 96px; height: 96px; background: #ffffff; padding: 0; text-align: center; vertical-align: middle;">
      <img
        src="https://github.com/user-attachments/assets/5166b04b-9d0a-410d-a178-6ab40ef47cd8"
        alt="Nequi"
        style="display: block; width: 72px; height: 72px; object-fit: contain; margin: 12px auto;"
      />
    </td>
    <td style="border: 1px solid #cfcfcf; border-left: none; height: 96px; padding: 14px 16px; vertical-align: middle;">
      <h3 style="margin: 0 0 8px 0;">Mid Software Engineer</h3>
      <p style="margin: 0; line-height: 1.35;">
        Nequi ·<br/> Medellín, Colombia (Remote)<br/> <strong>2023 - 2025</strong>
      </p>
    </td>
  </tr>
  ...
  <tr>
    <td style="border: 1px solid #cfcfcf; width: 96px; height: 96px; background: #ffffff; padding: 0; text-align: center; vertical-align: middle;">
      <img
        src="https://github.com/user-attachments/assets/0471a6b8-ab7e-4467-933e-6ed8b9fbc33b"
        alt="Suramericana"
        style="display: block; width: 72px; height: 72px; object-fit: contain; margin: 12px auto;"
      />
    </td>
    <td style="border: 1px solid #cfcfcf; border-left: none; height: 96px; padding: 14px 16px; vertical-align: middle;">
      <h3 style="margin: 0 0 8px 0;">Junior Software Engineer</h3>
      <p style="margin: 0; line-height: 1.35;">
        Sofka (Suramericana) ·<br/> Medellín, Colombia (On site)<br/> <strong>2021 - 2022</strong>
      </p>
    </td>
  </tr>
</table>
...
### 🛠 TECH STACK
  ...
  <h4>Next.js - Css - JavaScript- StoryBook - tailwindCSS</h4> 
  </div> 
  ...
  <img src="https://readme-components.vercel.app/api?component=logo&fill=ffffff&logo=go&text=false&svgfill=3472a2">
  <img src="https://readme-components.vercel.app/api?component=logo&fill=ffffff&logo=spring&text=false&svgfill=0db7ed">  
  <img src="https://readme-components.vercel.app/api?component=logo&fill=ffffff&logo=datadog&text=false&svgfill=000000">
  ...
  <h4>Node.js - Java - Goland - Spring - Datadog - Grafana - Sonarqube</h4>   
  </div>
  ...
  <img src="https://readme-components.vercel.app/api?component=logo&fill=ffffff&logo=googlecloud&text=false&svgfill=000000">
    <img src="https://readme-components.vercel.app/api?component=logo&fill=ffffff&logo=github&text=false&svgfill=000000">
  ...
  <h4>IBM - AWS - GCP - Github - Terraform - Jenkins - Docker</h4>  
  </div>
